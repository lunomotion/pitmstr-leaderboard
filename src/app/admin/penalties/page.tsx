  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Penalties</h1>
          <p className="text-slate-500 mt-1">
            Track rule violations and scoring penalties
          </p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden">
        <div className="flex flex-col items-center justify-center py-16">
          ...
          <p className="text-slate-600 font-medium">No penalties recorded</p>
          <p className="text-sm text-slate-400 mt-1">
            Penalty records will appear here when logged during events
          </p>
        </div>
      </div>
    </div>
